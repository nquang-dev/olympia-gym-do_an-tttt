      ...
      <div className="container mx-auto">
        ...
        >
          {stats.map((item, index) => {
            return (
              <motion.div variants={statsItem} key={index}>
                {/* circle outer */}
                <div className="border border-accent/90 w-[140px] h-[140px] mx-auto rounded-full p-1  mb-6">
                  {/* circle inner & count number */}
                  <div
                    ref={ref}
                    className="border border-accent/30 w-ful h-full flex items-center justify-center text-5xl rounded-full"
                  >
                    {isInView && (
