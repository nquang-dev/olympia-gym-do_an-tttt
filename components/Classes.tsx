...
const classes = [
  {
    ...
    description:
      "Bodybuilding giúp bạn xây dựng cơ bắp mạnh mẽ và đạt thân hình lý tưởng với phương pháp tập luyện chuyên sâu.",
  },
  {
    name: "cardio",
    img: "/assets/img/classes/cardio.jpg",
    description:
      "Cardio giúp bạn tăng cường sức bền và đốt cháy mỡ thừa hiệu quả với các bài tập năng động. ",
  },
  {
    name: "fitness",
    img: "/assets/img/classes/fitness.jpg",
    description:
      "Fitness cải thiện toàn diện sức khỏe và vóc dáng với các bài tập đa dạng và linh hoạt.",
  },
  {
    name: "crossfit",
    img: "/assets/img/classes/crossfit.jpg",
    description:
      "CrossFit kết hợp các bài tập chức năng với cường độ cao, giúp bạn nâng cao sức mạnh, sức bền và thể lực tổng quát.",
  },
];
  ...
  return (
    <section id="class">
      <motion.div
        ...
        className="grid grid-cols lg:grid-cols-2"
      >
